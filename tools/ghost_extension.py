...
VERSION = "3.0-PRO"
PROFILE = "Open-source intelligence asset and entity aggregator"
RULES = [('OSINT-SOURCE', 'source|reference|URL|domain'), ('OSINT-IDENTITY', 'email|username|company|organization'), ('OSINT-CONTACT', 'contact|phone|address|social')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-OSINT-God v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
